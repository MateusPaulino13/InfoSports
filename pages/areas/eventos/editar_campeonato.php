    ...
    <html lang="pt-br">
        ...
        <body>
            <form method="POST" enctype="multipart/form-data">
                <input type="text" placeholder="<?php echo $campeonato['name'] ?>" name="name" id="name">

                <br>

                <input type="text" placeholder="<?php echo $campeonato['location'] ?>" name="location">

                <br>

                <textarea rows="2" cols="30" placeholder="<?php echo $campeonato['description'] ?>" type="text" name="description"></textarea>
