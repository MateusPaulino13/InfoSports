...
<body>
    <button id="myBtn">Novo Campeonato</button>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <form method="POST" action="../../../actions/regCampeonato.php" enctype="multipart/form-data">
                ...
                <input required type="file" id="img" name="img" id="imgCampeonato">
